 ...
 *   logto-upstream/packages/core/src/routes/admin-user/mfa-verifications.ts
 *
 ...
 * instead of the request hostname. Pure display change; the issuer is not part
 * of the TOTP HMAC, so generation/verification is unchanged.
 */
