...
export const createDefaultSignInExperience = (
  ...
  Object.freeze({
    ...
    branding: {
      logoUrl: isCloud ? undefined : 'https://m.nicematrix.com/branding/NiceMatrix-170x64.svg',
      darkLogoUrl: isCloud ? undefined : 'https://m.nicematrix.com/branding/NiceMatrix-170x64.svg',
    },
...
export const createAdminTenantSignInExperience = (): Readonly<CreateSignInExperience> =>
  Object.freeze({
    ...
    branding: {
      logoUrl: 'https://m.nicematrix.com/branding/NiceMatrix-170x64.svg',
      darkLogoUrl: 'https://m.nicematrix.com/branding/NiceMatrix-170x64.svg',
    },
    mfa: {
