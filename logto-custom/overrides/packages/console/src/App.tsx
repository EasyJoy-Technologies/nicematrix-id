...
import { adminConsoleApplicationId, adminTenantId, PredefinedScope, TenantScope } from '@logto/schemas';
...
function Providers() {
  ...
  // For OSS, admin console management APIs are bound to admin tenant resource.
  const resources = useMemo(
    () =>
      isCloud
        ? [cloudApi.indicator, meApi.indicator]
        : [getManagementApi(adminTenantId).indicator, meApi.indicator],
    []
  );
